...
#La fracción de los datos de A que tienen valores entre 5 y 10 es: 0.25
...
#La fracción de los datos de B que tienen valores entre 10 y 15 es: 0.1
...
#La media de los datos de A es: 3.456 
#La media de los datos de B es: 5.7635 

var_A <- var(data$A)
cat("La varianza de los datos de A es:", var_A, "\n")
var_B <- var(data$B)
cat("La varianza de los datos de B es:", var_B, "\n")
#La varianza de los datos de A es: 9.707352 
#La varianza de los datos de B es: 36.94455

#skewness
skewness_A <- moments::skewness(data$A)
cat("El valor de asimetria de los datos de A es:", skewness_A, "\n")
skewness_B <- moments::skewness(data$B)
#El valor de asimetria de los datos de A es: 0.8464506 
#El valor de asimetria de los datos de B es: 1.139205 
...
#La curtosis de los datos de A es: 2.387666 
#La curtosis de los datos de B es: 2.919814
...
#Los cuantiles de los datos de A es: 0.09 0.9825 2.51 5.72 10.2 
#Los cuantiles de los datos de B es: 0.24 1.675 2.955 7.37 19.74 
...
#La mediana de los datos de A es: 2.51 
#La mediana de los datos de B es: 2.955 
...
#El valor del rango intercuartil de los datos de A es: 4.7375 
#El valor del rango intercuartil de los datos de B es: 5.695 
...
#Los valores atipicos dentro de los datos de A son:  
#Los valores atipicos dentro de los datos de B son: 19.74 
...
#El área a limpiar para una concetración crítica de 5 mg/kg es: 2400 
#El área a limpiar para una concetración crítica de 10 mg/kg es: 2000 
...
#El coeficiente de correlación entre los valores de A y B es: 0.67559
...
#La fracción de los datos que tiene un valor A menor que 5 y un valor B menor que 10 es: 0.65 
...
#La fracción de los datos que tiene un valor A menor que 5 o un valor B menor que 10 es: 0.8 
